...
<html>
<head>
<title> Login at LondonCosmeticsBd </title>
...
<div class="checkoutL">
 ...
 <div class="container signinContent loginType_d">
    ...
    <div class="registeredContent">
        ...
        <div class="forgottenpassword"><a href="forgotepassword.php">Forgot your password?</a></div>
	...
	<td style="width:500px;">
	 ...
	 <form name="loginform" id="loginform" method="post" action="signup.php" onSubmit="return passEmail();">
        ...
        <fieldset class="dontFloat f-loginiam notregister">
            ...
            <p class="newcusttxt" style="float:left; width:225px; display:inline;">Welcome. Register here for LondonCosmeticsBd  </p>
