...
<html>
<head>
<title>Offers at LondonCosmeticsBd</title>
...
<!-- start of crumbtrail -->
<div class="Lcat_crumbtrail-con"><p class="Lcattree crumbtrail"><a href="index.php" class="treehome">Home</a><a href="offers_page.php" class="menuFontNonSelected">Offers</a></p>
...
var pr_style_sheet="http://www.superdrug.com/content/ebiz/superdrug/resources/css/powerreviews.css";</script>
    ...
    <span class="brandtitle">Offers </span>
...
<div id="catgoldspot"> 
		  ...
		  <div class="box boxSearchAlt">
				...
				<?php include('offers_middle_page.php'); ?>
