...
<!-- ELECTRICALS -->
 ...
 <!-- START HEALTH -->
    <li id="health" class="cathealth catlist catlistno8"><a class="parentone" href="category_page.php?cat_id=9" title="Health">Food</a>
...
<!--start Gift-->
<li class="catlist catlistno11" style=""><a class="parentone"  href="category_page.php?cat_id=12" title="Gift Items">Gift Shop</a>
      ...
      <div class="subNav-2012 snhealth catno clearfix">
        <div class="subNavWrap-2012">
          <div class="shopbycat scatlist btnavbigred">
            ...
            <ul class="subNav">
               <li class="subhe-lifestyle subitem10"><a class="parenttwo" href="category_product.php?sub_category_id=<?php echo $gift_data['sub_category_id']; ?>" title="Healthy Lifestyle"><?php echo $gift_data['sub_category_name'];?></a> </li>
               <?php
				}
			}
          ...
          <div class="shopbybrand scatlist">
			...
			if($gift_brand != NULL)
			{
				...
				{
			?>
              <li><a href="category_product.php?sub_category_id=<?php echo $gift_info['sub_category_id']; ?>&brand_id=<?php echo $gift_info['brand_id']; ?>" title="Celebrity Slim"> <?php $gift_info['brand_name'];?> </a></li>
