...
$sub_cat = new categoryProduct($sub_category_id , $type_id , $brand_id);
?>
...
<html>
<head>
<title><?php $name = $sub_cat->getName(); echo $name['category_name']; ?> at LondonCosmeticsBd</title>


<meta name="description" content="Hair products on londoncosmeticsbd.com including hair dye, shampoo, conditioner, styling and accessories. Buy great brands including John Frieda, Nice N Easy, Aussie, Tresemme, L’Oreal Elvive. View and add reviews to the great products you’re tried" />
    <meta name="keywords" content="Buy hair products online at londoncosmeticsbd.com, offers, reviews, savings, discounts, shampoo, conditioner, styling, hair dye and dye removal, hair care, accessories, salon hair care, John Frieda, Colour B4, L’Oreal, Tresemme, Aussie, Nice n easy, Garnier" />
...
<!-- start of crumbtrail -->
<div class="Lcat_crumbtrail-con"><p class="Lcattree crumbtrail"><a href="index.php" class="treehome">Home</a><a href="category_page.php?cat_id=<?php echo $name['category_id']; ?>" class="menuFontNonSelected"><?php  echo $name['category_name']; ?></a><a href="category_product.php?sub_category_id=<?php echo $name['sub_category_id']; ?>" class="menuFontNonSelected"><?php echo $name['sub_category_name']; ?></a></p>
...
var pr_style_sheet="http://www.superdrug.com/content/ebiz/superdrug/resources/css/powerreviews.css";</script>
   ...
   if(isset($_REQUEST['brand_id']))
   {
       echo $sub_cat->getBrandName($_REQUEST['brand_id']); ?>
...
<div id="catgoldspot"> 
		  ...
		  <div class="box boxSearchAlt">
				...
				<?php include('category_product_middle.php'); ?>
...
<script type="text/javascript" src="js/peerius.page.js" charset="UTF-8"></script>
<!-- End Peerius -->
