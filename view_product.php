...
<html>
<head>
<title> <?php echo $product_info['product_name']; ?> at London Cosmetics BD in Bangladesh </title>
...
<div class="Lcat_crumbtrail-con"><p class="Lcattree crumbtrail"><a href="index.php" class="treehome">Home</a>
<a href="category_page.php?cat_id=<?php  echo $product_info['category_id']; ?>" class="menuFontNonSelected"><?php  echo $product_info['category_name']; ?></a>
<a href="category_product.php?sub_category_id=<?php  echo $product_info['sub_category_id']; ?>" class="menuFontNonSelected"><?php  echo $product_info['sub_category_name']; ?></a>
<a href="view_product.php?product_id=<?php  echo $product_info['product_id']; ?>" class="menuFontNonSelected"><?php  echo $product_info['product_name']; ?></a>
</p>
</div>
<!-- end of crumbtrail -->
...
<?php include('view_product_middle.php'); ?>
