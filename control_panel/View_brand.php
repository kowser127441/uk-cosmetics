...
<table class="data display datatable" id="example" style="width:850px; magin-left:100px;">
		...
		<tbody>
						...
						$p_query=mysql_query("SELECT * FROM brand");	
						while($h_data=mysql_fetch_array($p_query))
						{	
							$brand_id = $h_data['brand_id'];
							$brand_name = $h_data['brand_name'];
			...
			<tr class="odd gradeX">
                ...
                <td class="center">
				<?php echo $h_data['brand_id']; ?>
                </td>
                
				<td class="center">
				<?php echo $h_data['brand_name']; ?>
                </td>
                 ...
                 <td class="center" style="width:150px;">
                  ...
                  <a href="edit_brand.php?brand_id=<?php echo $brand_id; ?>">Edit</a> |
                  <a href="remove_brand.php?brand_id=<?php echo $brand_id; ?>" onClick="return confarmation()" >Remove</a>
