...
<h2>Add Background Image</h2>
 ...
 <?php
   ...
   
   {
    ...
    <br/><br/><br/>
    <form method="post" enctype="multipart/form-data"  action="adding_background_image.php" style="margin-left:20px"  name="myForm" onsubmit="return validateForm()">
    ...
    <table width="500" border="0">
        ...
        <br/>
        <span style="color:#F00">Image Resulation - 1604*1123 px </span>
        </td>
        </tr>
...
<table class="data display datatable" id="example" style="width:800px;">
		...
		<tbody>
						...
						$p_query=mysql_query("SELECT * FROM background_image ");	
			...
			<tr class="odd gradeX">
                ...
                <td class="center">
					 <img src="<?php echo $pic_url; ?>" style="width:800px;" >
