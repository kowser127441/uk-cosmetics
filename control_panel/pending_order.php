...
<table class="data display datatable" id="example" style="width:850px;">
		...
		<tbody>
					...
					$sqlCategory=mysql_query("SELECT * FROM order_table WHERE status='pending' ORDER BY order_id DESC");
			...
			<tr class="odd gradeX">
                ...
                <td class="center">
                 ...
                 <td  class="center">
					...
					<form action="dispass.php" method="get">
                <input type="hidden" name="order_id" value="<?php echo  $rowCategory['order_id']; ?>" >
                 <input type="hidden" name="moblie" value="<?php echo  $mobile; ?>" >
              <!--  <input type="text" name="verification_code" >-->
                <input type="submit" value="Dispass" >
