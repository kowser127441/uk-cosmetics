...
<?php
// $iframe = '<div style="width:auto; height:auto;"><iframe width="560" height="315" src="//www.youtube.com/embed/ASO_zypdnsQ" frameborder="0" allowfullscreen></iframe></div>';

$iframe = $_REQUEST['iframe'];


$embed_code = youtubeEmbedFromUrl($iframe, 400, 300);
echo $embed_code ;
