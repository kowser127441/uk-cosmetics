...
<h2>Add Product In Order</h2>
 ...
 ?>   
    ...
    <br/><br/><br/>
    <form method="post" enctype="multipart/form-data" action="add_order_product.php" style="margin-left:20px"  name="myForm" onsubmit="return validateForm-duisabled()">
         ...
         <tr>
          <td></td>
            ...
            <input type="submit" value="Search"  style="margin-left:100px; height:30px; width:80px; font-size:15px;">
                ...
                <form action="add_order_product.php" method="POST" enctype="multipart/form-data"> 
                    <input type="hidden" name="order_id" value="<?php echo $order_id?>">
                <td>
