...
<h2>View Product</h2>
 ...
 ?>   
    ...
    <br/><br/><br/>
    <form method="post"   action="view_favourites_product.php" style="margin-left:20px"  name="myForm" onsubmit="return validateForm-duisabled()">
...
<table class="data display datatable" id="example" style="width:850px; magin-left:100px;">
		...
		<tbody>
						...
						$p_query=mysql_query("SELECT * FROM favourites ");	
			...
			<tr class="odd gradeX">
                ...
                <a href="remove_fav_product.php?product_id=<?php echo $product_id; ?>"  onClick="return confarmation()">Remove</a>
