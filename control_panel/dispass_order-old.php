...
<table class="data display datatable" id="example" style="width:850px;">
		...
		<tbody>
					...
					$sqlCategory=mysql_query("SELECT * FROM order_table WHERE status='dispass' ORDER BY order_id DESC");
			...
			<tr class="odd gradeX">
                ...
                <td class="center">
					...
					<a href="success.php?order_id=<?php echo $rowCategory['order_id']; ?>" > Success </a>
                </td>
