...
<!-- start of crumbtrail -->
<div class="Lcat_crumbtrail-con"><p class="Lcattree crumbtrail"><a href="index.php" class="treehome">Home</a><a href="searching_result.php" class="menuFontNonSelected">Search</a></p>
...
var pr_style_sheet="http://www.superdrug.com/content/ebiz/superdrug/resources/css/powerreviews.css";</script>
    ...
    <span class="brandtitle">Search </span>
...
<div id="catgoldspot"> 
		  ...
		  <div class="box boxSearchAlt">
				...
				<?php include('search_middle_page.php'); ?>
