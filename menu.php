        ...
        <div class="subNavWrap-2012">
          ...
          <div class="shopbybrand scatlist">
            ...
            foreach($brand as $brand_data)
				{
			?>
              <li><a href="category_product.php?category_id=1&brand_id=<?php echo $brand_data['brand_id']; ?>&brand=by_brand" title="<?php echo $brand_data['brand_name']; ?>"> <?php echo $brand_data['brand_name']; ?> </a></li>
        ...
        <div class="subNavWrap-2012">
          ...
          <div class="shopbybrand scatlist">
		   ...
		   if($brand1 != NULL)
            ...
            <li><a href="category_product.php?category_id=2&brand_id=<?php echo $brand_data1['brand_id'];?>&brand=by_brand" title="<?php echo $brand_data1['brand_name']; ?>"><?php echo $brand_data1['brand_name']; ?></a></li>
        ...
        <div class="subNavWrap-2012">
          ...
          <div class="shopbybrand scatlist">
			...
			?>
              ...
              <li><a href="category_product.php?category_id=4&brand_id=<?php echo $hair_data['brand_id']; ?>&brand=by_brand" title="<?php echo $hair_data['brand_name']; ?>"> <?php echo $hair_data['brand_name']; ?> </a></li>
        ...
        <div class="subNavWrap-2012">
          ...
          <div class="shopbybrand scatlist">
			...
			?>
              ...
              <li><a href="category_product.php?category_id=6&brand_id=<?php echo $men_info['brand_id']; ?>&brand=by_brand" title="<?php echo $men_info['brand_name'];?>"> <?php echo $men_info['brand_name'];?> </a></li>
              <?php 
				}
			}
              ?>
      ...
      <div class="subNav-2012 snfragrance catno clearfix">
        <div class="subNavWrap-2012">
          ...
          <div class="shopbybrand scatlist">
            ...
            <li><a href="category_product.php?category_id=3&brand_id=<?php echo $brand_data2['brand_id']; ?>&brand=by_brand" title="<?php echo $brand_data2['brand_name']; ?>"><?php echo $brand_data2['brand_name']; ?></a></li> 
             <?php
              }
			  ?>
            </ul>
        ...
        <div class="subNavWrap-2012">
          ...
          <div class="shopbybrand scatlist">
			...
			?>
              ...
              <li><a href="category_product.php?category_id=7&brand_id=<?php echo $baby_info['brand_id']; ?>&brand=by_brand" title="<?php echo $baby_info['brand_name'];?>"><?php echo $baby_info['brand_name'];?></a></li>
              <?php
				}
			}
			  ?>
        ...
        <div class="subNavWrap-2012">
          ...
          <div class="shopbybrand scatlist">
			...
			?>
              ...
              <li><a href="category_product.php?category_id=8&brand_id=<?php echo $Electricals_info['brand_id']; ?>&brand=by_brand" title="<?php echo $Electricals_info['brand_name']; ?>"> <?php echo $Electricals_info['brand_name']; ?> </a></li>
              <?php
				}
			}
        ...
        <div class="subNavWrap-2012">
          ...
          <div class="shopbybrand scatlist">
			...
			if($garments_brand != NULL)
			{
				...
				{
			?>
              <li><a href="category_product.php?category_id=10&brand_id=<?php echo $garments_info['brand_id']; ?>&brand=by_brand" title=" <?php echo $garments_info['brand_name'];?>"> <?php echo $garments_info['brand_name'];?> </a></li>
        ...
        <div class="subNavWrap-2012">
          ...
          <div class="shopbybrand scatlist">
			...
			if($food_brand != NULL)
			{
				...
				{
			?>
              <li><a href="category_product.php?category_id=11&brand_id=<?php echo $food_info['brand_id']; ?>&brand=by_brand" title=" <?php echo $food_info['brand_name'];?>"> <?php echo $food_info['brand_name'];?> </a></li>
...
<!--End Chocolate--> 
 ...
 <!-- START  FOOD & BEVRAGE -->
    <li id="health" class="cathealth catlist catlistno8"><a class="parentone" href="category_page.php?cat_id=9" title="FOOD & BEVRAGE">Food & Bevarage</a>
        ...
        <div class="subNavWrap-2012">
          ...
          <div class="shopbybrand scatlist">
			...
			if($health_brand != NULL)
			{
				...
				{
			?>
              <li><a href="category_product.php?category_id=9&brand_id=<?php echo $health_info['brand_id']; ?>&brand=by_brand" title="<?php echo $health_info['brand_name'];?>"> <?php echo $health_info['brand_name'];?> </a></li>
...
<!--start Gift-->
<li class="catlist catlistno11" style=""><a class="parentone"  href="category_page.php?cat_id=12" title="Gift Shop">Valentine's</a>
        ...
        <div class="subNavWrap-2012">
          ...
          <div class="shopbybrand scatlist">
			...
			if($gift_brand != NULL)
			{
				...
				{
			?>
              <li><a href="category_product.php?category_id=12&brand_id=<?php echo $gift_info['brand_id']; ?>&brand=by_brand" title="<?php $gift_info['brand_name'];?>"> <?php $gift_info['brand_name'];?> </a></li>
        ...
        <div class="subNavWrap-2012">
          ...
          <div class="shopbybrand scatlist">
			...
			if($Toiletries_brand != NULL)
			{
			 ...
			 ?>
              <li><a href="category_product.php?category_id=5&brand_id=<?php echo $Toiletries_b_info['brand_id']; ?>&brand=by_brand" title="<?php echo $Toiletries_b_info['brand_name'];?>"><?php echo $Toiletries_b_info['brand_name'];?> </a></li>
              <?php 
				}
			}
              ?>
