...
<div id="mainNav-wrapper-2012">
  <ul class="mainNav clearfix" id="mainNav-2012">
    <li class="first catlist"><a class="parenthomelink" href="index.php" title="LondonCosmeticsBd Home">Home</a></li>
        ...
        <div class="subNavWrap-2012">
          <div class="shopbycat scatlist btnavbigred">
			...
			?>
              ...
              <li class="submu-face subitem"><a class="parenttwo" href="category_product.php?sub_category_id=<?php echo $sub_data['sub_category_id']; ?>" title="<?php echo $sub_data['sub_category_name'];?>"><?php echo $sub_data['sub_category_name'];?></a></li>
          ...
          <div class="shopbybrand scatlist">
            ...
            foreach($brand as $brand_data)
				{
			?>
              <li><a href="category_product.php?category_id=1&brand_id=<?php echo $brand_data['brand_id']; ?>" title="<?php echo $brand_data['brand_name']; ?>"> <?php echo $brand_data['brand_name']; ?> </a></li>
...
<!-- SKIN -->
      ...
      <div class="subNav-2012 snskincare catno clearfix">
        <div class="subNavWrap-2012">
          <div class="shopbycat scatlist btnavbigred">
            ...
            <ul class="subNav">
              <li class="subsk-face subitem1"><a class="parenttwo" href="category_product.php?sub_category_id=<?php echo $sub_data1['sub_category_id'];?>" title="<?php echo $sub_data1['sub_category_name']; ?>"><?php echo $sub_data1['sub_category_name']; ?></a></li>
          ...
          <div class="shopbybrand scatlist">
		   ...
		   if($brand1 != NULL)
            ...
            <li><a href="category_product.php?category_id=2&brand_id=<?php echo $brand_data1['brand_id'];?>" title="<?php echo $brand_data1['brand_name']; ?>"><?php echo $brand_data1['brand_name']; ?></a></li>
  ...
  <li class="manuka_2013e9"><a href="view_product.php?product_id=<?php echo $offers_data1['product_id']; ?>" title="<?php echo $offers_data1['product_name']; ?>">
      ...
      <div class="subNav-2012 snhair catno clearfix">
        <div class="subNavWrap-2012">
          <div class="shopbycat scatlist btnavbigred">
            ...
            <ul class="subNav">
              <li class="subhr-hairshampoos subitem11"><a class="parenttwo" href="category_product.php?sub_category_id=<?php echo $sub_data3['sub_category_id']; ?>" title="<?php echo $sub_data3['sub_category_name']; ?>"> <?php echo $sub_data3['sub_category_name']; ?> </a></li>
              <?php 
			 }
			  ?>
          ...
          <div class="shopbybrand scatlist">
			...
			?>
              ...
              <li><a href="category_product.php?category_id=4&brand_id=<?php echo $hair_data['brand_id']; ?>" title="<?php echo $hair_data['brand_name']; ?>"> <?php echo $hair_data['brand_name']; ?> </a></li>
...
<?php echo $hair_data['product_name']; ?>
      ...
      <div class="subNav-2012 snmens catno clearfix">
        <div class="subNavWrap-2012">
          <div class="shopbycat scatlist btnavbigred">
			...
			?>
            <ul class="subNav">
              <li class="subme-accessories subitem1"><a class="parenttwo" href="category_product.php?sub_category_id=<?php echo $men_data['sub_category_id']; ?>" title="<?php echo $men_data['sub_category_name'];?>"><?php echo $men_data['sub_category_name'];?></a></li>
              <?php
				}
			}
          ...
          <div class="shopbybrand scatlist">
			...
			?>
              ...
              <li><a href="category_product.php?category_id=6&brand_id=<?php echo $men_info['brand_id']; ?>" title="<?php echo $men_info['brand_name'];?>"> <?php echo $men_info['brand_name'];?> </a></li>
              <?php 
				}
			}
              ?>
 ...
 <!-- START Perfume -->
 <li id="fragrance" class="catfragrance catlist catlistno3"><a class="parentone" href="category_page.php?cat_id=3" title="perfume">Perfume</a>
       <?php 
      ...
      <div class="subNav-2012 snfragrance catno clearfix">
        <div class="subNavWrap-2012">
          <div class="shopbycat scatlist btnavbigred">
            ...
            <ul class="subNav">
              <li class="subf_new subitem1"><a class="parenttwo" href="category_product.php?sub_category_id=<?php echo $sub_data2['sub_category_id']; ?>" title="<?php echo $sub_data2['sub_category_name']; ?>"> <?php echo $sub_data2['sub_category_name']; ?> </a></li>
          ...
          <div class="shopbybrand scatlist">
            ...
            <li><a href="category_product.php?category_id=3&brand_id=<?php echo $brand_data2['brand_id']; ?>" title="<?php echo $brand_data2['brand_name']; ?>"><?php echo $brand_data2['brand_name']; ?></a></li> 
             <?php
              }
			  ?>
            </ul>
  ...
  <li class="met-wk33-frag"><a href="view_product.php?product_id=<?php echo $offers_data2['product_id'] ;?>" title="<?php  echo $offers_data2['product_name'];?>">
      ...
      <div class="subNav-2012 sntoiletries catno clearfix">
        <div class="subNavWrap-2012">
          <div class="shopbycat scatlist btnavbigred">
            ...
            <ul class="subNav">
              <li class="subto-accessories subitem1"><a class="parenttwo" href="category_product.php?sub_category_id=<?php echo $baby_data['sub_category_id']; ?>" title="<?php echo $baby_data['sub_category_name'];?>"><?php echo $baby_data['sub_category_name'];?></a></li>
              <?php
					}
				}
			  ?>
          ...
          <div class="shopbybrand scatlist">
			...
			?>
              ...
              <li><a href="category_product.php?category_id=7&brand_id=<?php echo $baby_info['brand_id']; ?>" title="<?php echo $baby_info['brand_name'];?>"><?php echo $baby_info['brand_name'];?></a></li>
              <?php
				}
			}
			  ?>
...
<!-- ELECTRICALS -->
    ...
    <li id="electricals" class="catbaby catlist catlistno5"><a class="parentone" href="category_page.php?cat_id=8" title="Electricals">Electricals</a>
    <?php 
        ...
        <div class="subNavWrap-2012">
          <div class="shopbycat scatlist btnavbigred">
            ...
            <ul class="subNav">
              ...
              <li class="subel-toothbrushes subitem8"><a class="parenttwo" href="category_product.php?sub_category_id=<?php echo $Electricals_data['sub_category_id']; ?>" title="<?php echo $Electricals_data['sub_category_name']; ?>"><?php echo $Electricals_data['sub_category_name']; ?></a> </li>
              <?php 
				}
			}
			  ?>
          ...
          <div class="shopbybrand scatlist">
			...
			?>
              ...
              <li><a href="category_product.php?category_id=8&brand_id=<?php echo $Electricals_info['brand_id']; ?>" title="<?php echo $Electricals_info['brand_name']; ?>"> <?php echo $Electricals_info['brand_name']; ?> </a></li>
              <?php
				}
			}
      ...
      <div class="subNav-2012 snhealth catno clearfix">
        <div class="subNavWrap-2012">
          <div class="shopbycat scatlist btnavbigred">
            ...
            <ul class="subNav">
               <li class="subhe-lifestyle subitem10"><a class="parenttwo" href="category_product.php?sub_category_id=<?php echo $garments_data['sub_category_id']; ?>" title="<?php echo $garments_data['sub_category_name'];?>"><?php echo $garments_data['sub_category_name'];?></a> </li>
               <?php
				}
			}
          ...
          <div class="shopbybrand scatlist">
			...
			if($garments_brand != NULL)
			{
				...
				{
			?>
              <li><a href="category_product.php?category_id=10&brand_id=<?php echo $garments_info['brand_id']; ?>" title=" <?php echo $garments_info['brand_name'];?>"> <?php echo $garments_info['brand_name'];?> </a></li>
      ...
      <div class="subNav-2012 snhealth catno clearfix">
        <div class="subNavWrap-2012">
          <div class="shopbycat scatlist btnavbigred">
            ...
            <ul class="subNav">
               <li class="subhe-lifestyle subitem10"><a class="parenttwo" href="category_product.php?sub_category_id=<?php echo $food_data['sub_category_id']; ?>" title="<?php echo $food_data['sub_category_name'];?>"><?php echo $food_data['sub_category_name'];?></a> </li>
               <?php
				}
			}
          ...
          <div class="shopbybrand scatlist">
			...
			if($food_brand != NULL)
			{
				...
				{
			?>
              <li><a href="category_product.php?category_id=11&brand_id=<?php echo $food_info['brand_id']; ?>" title=" <?php echo $food_info['brand_name'];?>"> <?php echo $food_info['brand_name'];?> </a></li>
...
<!--End Chocolate--> 
 ...
 <!-- START  FOOD & BEVRAGE -->
    <li id="health" class="cathealth catlist catlistno8"><a class="parentone" href="category_page.php?cat_id=9" title="FOOD & BEVRAGE"> <span style="font-size:11px; font-weight:500"> Food & Bevarage </span></a>
      ...
      <div class="subNav-2012 snhealth catno clearfix">
        <div class="subNavWrap-2012">
          <div class="shopbycat scatlist btnavbigred">
            ...
            <ul class="subNav">
               <li class="subhe-lifestyle subitem10"><a class="parenttwo" href="category_product.php?sub_category_id=<?php echo $health_data['sub_category_id']; ?>" title="<?php echo $health_data['sub_category_name'];?>"><?php echo $health_data['sub_category_name'];?></a> </li>
               <?php
				}
			}
          ...
          <div class="shopbybrand scatlist">
			...
			if($health_brand != NULL)
			{
				...
				{
			?>
              <li><a href="category_product.php?category_id=9&brand_id=<?php echo $health_info['brand_id']; ?>" title="<?php echo $health_info['brand_name'];?>"> <?php echo $health_info['brand_name'];?> </a></li>
...
<!--start Gift-->
<li class="catlist catlistno11" style=""><a class="parentone"  href="category_page.php?cat_id=12" title="Gift Shop">Gift Shop</a>
      ...
      <div class="subNav-2012 snhealth catno clearfix">
        <div class="subNavWrap-2012">
          <div class="shopbycat scatlist btnavbigred">
            <h3>Shop by Category</h3>
            <?php
			$gift_sub_category = $gift->getSubcategory();
			if($gift_sub_category != NULL)
			{
				foreach($gift_sub_category as $gift_data)
				{
            ...
            <ul class="subNav">
               <li class="subhe-lifestyle subitem10"><a class="parenttwo" href="category_product.php?sub_category_id=<?php echo $gift_data['sub_category_id']; ?>" title="<?php echo $gift_data['sub_category_name'];?>"><?php echo $gift_data['sub_category_name'];?></a> </li>
               <?php
				}
			}
          ...
          <div class="shopbybrand scatlist">
            <h3>Top Brands</h3>
            <?php $gift_brand = $gift->getBrand();
			 ?>
            <ul class="subNavlist">
            <?php
			if($gift_brand != NULL)
			{
				foreach($gift_brand as $gift_info)
				{
			?>
              <li><a href="category_product.php?category_id=12&brand_id=<?php echo $gift_info['brand_id']; ?>" title="<?php $gift_info['brand_name'];?>"> <?php $gift_info['brand_name'];?> </a></li>
  ...
  <div class="shopbypromo scatlist scatlistlast">
    ...
    <ul class="subCatNav clearfix">
	  ...
	  if($gift_offer !=NULL)
	  {
		  foreach($gift_offer as $gift_info)
		  {

	  ?>

  <li class="2013e9_sdslenderplan"><a href="view_product.php?product_id=<?php echo $gift_info['product_id']; ?>" title="<?php echo $gift_info['product_name']; ?>">
   <?php echo $gift_info['product_name']; ?>
    </a></li>
    <?php 
		  }
	  }
...
<!-- Pharmacy -->
    ...
    <li id="toiletries" class="cattoiletries catlist catlistno12"><a class="parentone" href="category_page.php?cat_id=5" title="Pharmacy">Pharmacy</a>
      ...
      <div class="subNav-2012 sntoiletries catno clearfix">
        <div class="subNavWrap-2012">
          <div class="shopbycat scatlist btnavbigred">
			...
			?>
            <ul class="subNav">
              <li class="subto-accessories subitem1"><a class="parenttwo" href="category_product.php?sub_category_id=<?php echo $Toiletries_data['sub_category_id']; ?>" title="<?php echo $Toiletries_data['sub_category_name']; ?>"><?php echo $Toiletries_data['sub_category_name']; ?></a></li>
              <?php 
				 }
			 }
          ...
          <div class="shopbybrand scatlist">
			...
			if($Toiletries_brand != NULL)
			{
			 ...
			 ?>
              <li><a href="category_product.php?category_id=5&brand_id=<?php echo $Toiletries_b_info['brand_id']; ?>" title="<?php echo $Toiletries_b_info['brand_name'];?>"><?php echo $Toiletries_b_info['brand_name'];?> </a></li>
              <?php 
				}
			}
              ?>
