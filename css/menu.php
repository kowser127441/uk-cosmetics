        ...
        <div class="subNavWrap-2012">
          ...
          <div class="shopbybrand scatlist">
			...
			if($garments_brand != NULL)
			{
				...
				{
			?>
              <li><a href="category_product.php?category_id=10&brand_id=<?php echo $garments_info['brand_id']; ?>" title=" <?php $garments_info['brand_name'];?>"> <?php $garments_info['brand_name'];?> </a></li>
        ...
        <div class="subNavWrap-2012">
          ...
          <div class="shopbybrand scatlist">
			...
			if($food_brand != NULL)
			{
				...
				{
			?>
              <li><a href="category_product.php?category_id=11&brand_id=<?php echo $food_info['brand_id']; ?>" title=" <?php $food_info['brand_name'];?>"> <?php $food_info['brand_name'];?> </a></li>
        ...
        <div class="subNavWrap-2012">
          ...
          <div class="shopbybrand scatlist">
			...
			if($health_brand != NULL)
			{
				...
				{
			?>
              <li><a href="category_product.php?category_id=9&brand_id=<?php echo $health_info['brand_id']; ?>" title="<?php $health_info['brand_name'];?>"> <?php $health_info['brand_name'];?> </a></li>
