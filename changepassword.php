...
<div class="Lcat_crumbtrail-con">
  <p class="Lcattree crumbtrail"><a href="/" class="treehome">Home</a>Change Password</p>
</div>
<!-- end of crumbtrail -->
...
<div class="checkoutL">
 ...
 <div class="container signinContent loginType_d">
	...
	<script type="text/javascript" src="js/login.js"></script>
	 ...
	 <form name="secondloginform" id="secondloginform" method="post" action="changingpassword.php" onSubmit="return login_check();">
    ...
    <div class="registeredContent">
		<div class="regsiteredInner">   
            ...
            <p class="registertxt">&nbsp;</p>
            
			<table>
			<tr>
			<td>
			<label for="email" id="lLoginEmail">Old Password:</label>
			</td>
			<td>
			<input type="password" name="old_password" id="oldpassword" value="" size="20" maxlength="150">
			</td>
			</tr>
			
			<tr>
			<td>
			 <label for="password" id="lLoginPassword" title="Your password must be at least 5 characters long">New Password: </label>
			</td>
			<td>
			 <input type="password" name="new_password" id="newpassword" size="20" maxlength="30">
			</td>
			</tr>
            
            <tr>
			<td>
			 <label for="password" id="lLoginPassword" title="Your password must be at least 5 characters long">Confirm New Password: </label>
			</td>
			<td>
			 <input type="password" name="password" id="confirmpassword" size="20" maxlength="30">
			</td>
			</tr>
        ...
        <div class="forgottenpassword"></div>
