...
include('randomDetailsClass.php');

$position = $_REQUEST['position'];

$random = new Random($position);
...
<html>
<head>
<title> <?php echo $random->getTitle(); ?> at LondonCosmeticsBd </title>
...
<!-- start of crumbtrail -->
<div class="Lcat_crumbtrail-con"><p class="Lcattree crumbtrail"><a href="/" class="treehome">Home</a><a href="http://www.superdrug.com/hair/icat/hair" class="menuFontNonSelected"><?php echo $random->getTitle(); ?></a></p>
</div>
<!-- end of crumbtrail -->
...
<div id="categorylist">
  ...
  <!-- onicat -->
    ...
    <!-- solr bestsellers -->
    <h2 class="bestsellerstitle"><span id="hdrBestsellers"></span><?php echo $random->getTitle(); ?></h2>
