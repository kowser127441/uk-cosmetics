 ...
 // how many records should be displayed on a page?
   ...
   $MySQL = "
								...
								WHERE
									...
									product_name LIKE '%$q%' 
									OR
								category_id = (SELECT category_id FROM category WHERE category_name LIKE '%$q%'  LIMIT 1 )
									OR
							    sub_category_id = (SELECT sub_category_id FROM sub_category WHERE sub_category_name LIKE '%$q%' LIMIT 1 )
									OR
								brand_id = (SELECT brand_id FROM brand WHERE brand_name LIKE '%$q%' LIMIT 1 )
