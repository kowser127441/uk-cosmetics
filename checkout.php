...
<html>
<head>
<title> Checkout at London-Cosmetics </title>
...
<!-- start of crumbtrail -->
<div class="Lcat_crumbtrail-con"><p class="Lcattree crumbtrail"><a href="index.php" class="treehome">Home</a><a href="category_page.php?cat_id=<?php echo $category_id; ?>" class="menuFontNonSelected">Shoping Cart</a></p>
</div>
<!-- end of crumbtrail -->
