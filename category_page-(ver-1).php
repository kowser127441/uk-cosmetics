...
<html>
<head>
<title> <?php echo $cat->getCatName(); ?> at London-Cosmetics </title>
...
<li class="prolist1">
        <a title="Save 1/3 on selected Colour B4" href=""> 
...
<?php
   ...
   <a href="#" title="Shampoos">
   
   
   
   
   <span><?php echo $subCategory['sub_category_name']; ?></span> <span class="ga"></span> <img src="<?php echo $subCategory['picture']; ?>" name=icatimage alt="Shampoos">
